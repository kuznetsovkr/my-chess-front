...
import Board_before_game from "../../onboard/board_before_game";
import wait_senya from '../assets/wait.gif';
import fail_sessiya from '../assets/fail.png';
import Header from "../../onboard/Header";
import {Col, Container, Row} from "react-bootstrap";
import toast, { Toaster } from 'react-hot-toast';

const socket  = require('../../connection/socket').socket
const notify = () => toast('Ссылка скопирована!')
...
class ChessGame extends React.Component {
    ...
    render() {
        ...
        return (
        <React.Fragment>
        <div className='board_game' style = {{
      ...
      <React.Fragment>
        {opponentDidJoinTheGame ? (
                <div style={{backgroundColor:"#f4f4f4"}}>
                    ...
                    <Container>
                        <Row>
                            <Col className='col-8'>
                                    <div>
                                        <p className='nickname_user'>{opponentUserName} </p>
                                        <ChessGame
                                            gameId={gameid}
                                            color={color.didRedirect}
                                        />
                                        <p className='nickname_user'>{props.myUserName}</p>
                                    </div>
                            </Col>
                            <Col className='col-4'>
                                <div className='wait_opponent'>
                                    <p className='text_wait_opponent'>Игра началась!</p>
                                </div>
                            </Col>
                        </Row>
          ...
          <div style={{display:"flex", flexDirection:"column",
            ...
            <p className='text_exit'>Ошибка в игровой сессии</p>
            <img src={fail_sessiya} style={{maxWidth: 256}}/>
            ...
            <div style={{backgroundColor:"#f4f4f4"}}>
                ...
                <Container>
                    <Row>
                        ...
                        <Col className='col-4'>
                            <div className='wait_opponent'>
                                <p className='text_wait_opponent'>Ожидание соперника...</p>
                                <p style={{textAlign:"center"}}><img src={wait_senya}/></p>
                                <button
                                    className="btn btn-primary"
                                    onClick={() => {navigator.clipboard.writeText(domainName + "/game/" + gameid);notify();}}
